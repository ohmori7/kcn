...
struct kcndb_file *kcndb_db_table_create(enum kcn_formula_type);
void kcndb_db_table_close(struct kcndb_file *);
bool kcndb_db_record_add(struct kcndb_file *, struct kcndb_db_record *);
