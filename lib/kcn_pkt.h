...
void kcn_pkt_init(struct kcn_pkt_handle *, struct kcn_pkt *);
struct kcn_pkt *kcn_pkt_new(size_t);
...
bool kcn_pkt_enqueue(struct kcn_pkt_handle *, struct kcn_pkt_queue *);
bool kcn_pkt_fetch(struct kcn_pkt_handle *, struct kcn_pkt_queue *);
void kcn_pkt_drop(struct kcn_pkt_handle *, struct kcn_pkt_queue *);
